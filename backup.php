...
if ( ! file_exists( $maint ) ) {
	die ( "Please set the MW_INSTALL_PATH environment variable to your MediaWiki " .
		  "installationn's directory or put this script in the same directory as " .
		  "index.php for your wiki.\n" );
}
require_once $maint;
